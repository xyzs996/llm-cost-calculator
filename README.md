...
One coding-agent request — **382,560 cached input + 16,280 fresh input + 1,160 output** tokens, the measured 95.6% cache-hit mix — priced against the catalogue read **2026-09-12**. The 12 cheapest of 66:
...
| **$0.0388** | $1,164.17 | DeepSeek V4 Pro 0423 | $0.0641 | peak/off-peak |
...
| GLM 5.3 | 26 | 10.0% → 21.85% | Inceptron | DeepInfra | **+15.3%** |
