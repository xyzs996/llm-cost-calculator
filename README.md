...
One coding-agent request — **382,560 cached input + 16,280 fresh input + 1,160 output** tokens, the measured 95.6% cache-hit mix — priced against the catalogue read **2026-09-13**. The 12 cheapest of 66:
...
| GLM 5.3 | 26 | 10.0% → 21.85% | Reka | DeepInfra | **+29.2%** |
