...
One coding-agent request — **382,560 cached input + 16,280 fresh input + 1,160 output** tokens, the measured 95.6% cache-hit mix — priced against the catalogue read **2026-08-27**. The 12 cheapest of 59:
...
| GLM 5.2 | 37 | 10.0% → 25.0% | Sail Research | DigitalOcean | **+3.1%** |
